...
sys.path.append("/home/robot/catkin_ws/src/assignment5/src/lineFollower")
...
if __name__ == '__main__':
	...
	mega_plan = []
	plan_loc = '/home/robot/catkin_ws/src/assignment5/src/planner/plan_v8_1.txt'
	...
	raw_input("[Final Race] Press Enter to race...")  # Waits for ENTER key press
	
	print("[Final Race] length of plan: ", len(mega_plan))
